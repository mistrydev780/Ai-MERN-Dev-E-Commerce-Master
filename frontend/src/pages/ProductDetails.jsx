...
function ProductDetails() {
  ...
  if (products.length > 0 && productData) {
    ...
    return productData ? (
        <div>
            <div className='w-full min-h-screen md:h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-start flex-col lg:flex-row gap-[20px]'>
                ...
                <div className='lg:w-[50vw] w-full lg:h-[75vh] h-[40vh] lg:mt-[80px] flex items-start justify-start flex-col py-[20px] px-[30px] md:pb-[20px] md:pl-[20px] lg:pl-[0px] lg:px-[0px] lg:py-[0px] gap-[10px]'>
                    ...
                    <div className='flex items-center gap-1'>
                        ...
                        <p className='text-[30px] font-semibold pl-[5px] text-[white]'>(123)</p>
                        ...
                        <div className='flex gap-2'>
                            {
                                productData?.sizes?.map((item, index) => (
                                    <button
                                        key={index}
                                        className={`border py-2 px-4 rounded-md ${item === size
            ...
            <div className='w-[100%] min-h-[70vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start justify-start flex-col overflow-x-hidden'>
                ...
                <div className='w-[90%] md:h-[350px] h-[220px] bg-[#3336397c] border-[1px] border-[#80808049] text-[13px] md:text-[15px] lg:text-[20px] px-[20px] lg:ml-[100px] ml-[20px] rounded-md'>

                    <p className='w-[95%] h-[90%] flex items-center justify-center text-white leading-[1.6]'>
...
<div className='w-full mt-[100px]'>
  ...
  <div className='text-center mb-12'>
    ...
    <p className='text-gray-400 mt-4'>
      Discover Similar Styles You May Love ✨
    </p>
